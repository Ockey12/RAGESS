...
@DependencyClient
public struct CompilerArgumentsClient {
    public var arguments: () -> [String]?
    public var generate: (
        _ targetFilePath: String,
...
extension CompilerArgumentsClient: DependencyKey {
    public static var liveValue: CompilerArgumentsClient {
        ...
        @Sendable func getExecutableMacroPaths(derivedDataPath: String) -> [String] {
            let fileManager = FileManager.default
        ...
        @Sendable func getIncludePaths(in directory: String, ignoredDirectories: [String]) -> [String] {
        ...
        @Sendable func getWorkingDirectoryPath(sourceFilePath: String) -> String {
            let fileManager = FileManager.default
        ...
        return CompilerArgumentsClient(
            arguments: {
                sharedArguments
            },
            generate: { targetFilePath, buildSettings, sourceFilePaths, packages in
...
extension CompilerArgumentsClient {
...
//    }
//
//    func getIncludePaths(in directory: String, ignoredDirectories: [String]) -> [String] {
//        var includePaths: [String] = []
//        let fileManager = FileManager.default
//        guard let paths = try? fileManager.contentsOfDirectory(atPath: directory) else {
//            return []
